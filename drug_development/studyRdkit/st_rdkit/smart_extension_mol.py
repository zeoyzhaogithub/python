...
Draw.MolToImageFile(
    m,
    '/drug_development/studyRdkit/st_rdcit/img/mol53.jpg',
    legend=''
)
...
Draw.MolToImageFile(
    m,
    '/drug_development/studyRdkit/st_rdcit/img/mol54.jpg',
    legend=''
)
...
Draw.MolToImageFile(
    mol,
    '/drug_development/studyRdkit/st_rdcit/img/mol55.jpg',
...
Draw.MolToImageFile(
    sucrose_mol,
    '/drug_development/studyRdkit/st_rdcit/img/mol56.jpg',
    legend=''
)
...
Draw.MolToImageFile(
    erythromycin,
    '/drug_development/studyRdkit/st_rdcit/img/mol57.jpg',
    legend=''
)
