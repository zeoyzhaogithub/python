...
img.save('/drug_development/studyRdkit/st_rdcit/img/mol33.jpg')
# 反应物如下图所示：
...
Draw.MolToImageFile(
    m,
    "/drug_development/studyRdkit/st_rdcit/img/mol36.jpg",
)
...
img.save("/drug_development/studyRdkit/st_rdcit/img/mol37.jpg")
