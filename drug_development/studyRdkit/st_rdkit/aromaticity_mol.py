...
Draw.MolToImageFile(
    m,
    "/drug_development/studyRdkit/st_rdcit/img/mol44.jpg",
)
...
Draw.MolToImageFile(
    m,
    "/drug_development/studyRdkit/st_rdcit/img/mol45.jpg",
)
isAromatic0 = m.GetAtomWithIdx(0).GetIsAromatic()
...
Draw.MolToImageFile(
    m,
    "/drug_development/studyRdkit/st_rdcit/img/mol46.jpg",
)
# 获取分子的环信息
ri = m.GetRingInfo()
# 组成每个环的原子
...
Draw.MolToImageFile(
    m,
    "/drug_development/studyRdkit/st_rdcit/img/mol47.jpg",
)
